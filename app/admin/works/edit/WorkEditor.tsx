    ...
    <AdminShell section="works" wide hasUnsavedChanges={dirty}>
      ...
      <div className="mb-4 flex shrink-0 flex-wrap items-center gap-3">
        ...
        <input
          ...
          className="min-w-0 flex-1 rounded-[8px] border border-transparent bg-transparent px-2 py-1 text-[20px] font-semibold text-white outline-none transition-colors placeholder-fg-muted hover:border-[#424242] focus:border-[#48f4be]"
        />
          ...
          <div className="grid max-w-main grid-cols-2 gap-4">
            ...
            <div className="col-span-2">
              ...
              <textarea
                ...
                rows={3}
                className="w-full resize-y rounded-[8px] border border-[#424242] bg-[#1a1a1a] px-3 py-2 text-[14px] leading-[1.6] text-white outline-none transition-colors placeholder-fg-muted focus:border-[#48f4be]"
              />
            </div>
            <div className="col-span-2">
