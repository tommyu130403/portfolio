...
const ProjectCard: FC<ProjectCardProps> = ({ category, title, tags, image, href }) => (
  <div className="flex h-[363.5px] w-[280px] flex-col overflow-hidden rounded-[14px] border border-[#424242] bg-[#212121] shadow-[0_1px_3px_rgba(0,0,0,0.1),0_1px_2px_-1px_rgba(0,0,0,0.1)] shrink-0">
        ...
        <div className="flex h-5 items-center justify-between">
          ...
          {href ? (
            <a href={href} className="shrink-0">
              <Icon set="Base" name="link" className="h-4 w-4" />
            </a>
          ) : (
