...
const dInput =
  "w-full rounded-[8px] border border-border-light bg-[#141414] px-3 py-2 text-[13px] text-white placeholder-fg-muted outline-none transition-colors focus:border-primary";
const dBtnPrimary =
      ...
      <div className="flex min-h-0 flex-1">
        {(mode === "edit" || mode === "split") && (
          <textarea
            ...
            } h-full min-h-[320px] resize-none bg-[#141414] p-5 font-mono text-[13px] leading-[1.7] text-white/90 outline-none placeholder-fg-muted`}
            onKeyDown={(e) => {
