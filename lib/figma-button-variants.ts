 ...
 *
 * Button/Action: Status (default, hover), Type (primary, secondary)
 * Button/Function: Status (default, hover), Border (on, off)
 */

export type ButtonActionType = "primary" | "secondary";
export type ButtonActionStatus = "default" | "hover";

/** Button/Action のスタイルクラス */
export const BUTTON_ACTION = {
  base: "inline-flex cursor-pointer items-center justify-center rounded-full px-6 py-2 text-[16px] font-bold leading-6 transition-colors",
  type: {
    primary: {
      default: "bg-[#48F4BE] text-[#063320]",
      hover: "hover:bg-[#1E7859] hover:text-[#063320]",
    },
    secondary: {
